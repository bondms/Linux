...
alias phone-battery-details='adb shell dumpsys battery'
alias phone-stop-adb='adb kill-server'
...
alias qiv='qiv -Rm'
alias radiofip-play-live='play-radio.sh http://direct.fipradio.fr/live/fip-midfi.mp3'
alias radiovarna-play-live='play-radio.sh http://broadcast.masters.bg:8000/live'
...
alias view-picture='feh --auto-zoom --hide-pointer --draw-filename --fullscreen --'
alias where='type -a'
alias wodim='wodim -v'
